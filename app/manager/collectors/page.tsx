...
export default async function ManagerCollectorsPage() {
      ...
      <div className="container mx-auto px-3 md:px-4 py-4 md:py-6">
        <div className="mb-4 md:mb-6">
          ...
          <p className="text-gray-600 mt-1 text-sm md:text-base">
            Yig'uvchilar ro'yxati va boshqaruvi
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 md:p-12 text-center">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">
                Yig'uvchilar hozircha yo'q
              </h3>
              <p className="text-sm md:text-base text-gray-600 mb-6">
                Hozircha yig'uvchilar yaratilmagan. Yig'uvchilarni yaratish uchun super-admin bilan bog'laning.
              </p>
              <a
                href="/manager/dashboard"
