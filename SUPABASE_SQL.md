...
**⚠️ ВАЖНО**: Не копируйте markdown разметку (```sql и ```)!

**Проще всего**: Откройте файл `supabase/01_initial_schema.sql` и скопируйте оттуда весь текст (без markdown).

Или скопируйте весь блок ниже (БЕЗ строк с ```):
...
**Или откройте файл**: `supabase/01_initial_schema.sql` и скопируйте весь текст оттуда

---

## Шаг 2: Настройка Row Level Security (RLS)

**⚠️ ВАЖНО**: Не копируйте markdown разметку!

**Проще всего**: Откройте файл `supabase/02_rls_policies.sql` и скопируйте оттуда весь текст.
...
**Или откройте файл**: `supabase/02_rls_policies.sql` и скопируйте весь текст оттуда
...
**Проще всего**: Откройте файл `supabase/03_enable_realtime.sql` и скопируйте оттуда весь текст.
